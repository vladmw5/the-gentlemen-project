 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */rr="",Ut(new Ge("platform-logger",(function(e){return new Tt(e)}),"PRIVATE")),Ut(new Ge("heartbeat",(function(e){return new Zt(e)}),"PRIVATE")),zt(Rt,At,rr),zt(Rt,At,"esm2017"),zt("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
function Ln(e){var t,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[];switch(e){case"Browser":t=bn(Ne());break;case"Worker":t="".concat(bn(Ne()),"-").concat(e);break;default:t=e}var n=r.length?r.join(","):"FirebaseCore-web";return"".concat(t,"/","JsCore","/").concat(qt,"/").concat(n)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pn(e){return Je(e)}var Mn=function(){"use strict";function t(r){var n,i,a=this;e(ne)(this,t),this.auth=r,this.observer=null,this.addObserver=(i=new ze((function(e){return a.observer=e}),n)).subscribe.bind(i)}return e(ie)(t,[{key:"next",get:function(){return br(this.observer,this.auth,"internal-error"),this.observer.next.bind(this.observer)}}]),t}();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
e(O)(e(A).mark((function t(r,n){return e(A).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Fr(r,"POST","/v1/accounts:signInWithPassword",Mr(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Vn(e,t){return qn.apply(this,arguments)}function qn(){return(qn=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
e(O)(e(A).mark((function t(r,n){return e(A).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Fr(r,"POST","/v1/accounts:signInWithEmailLink",Mr(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}function Wn(e,t){return zn.apply(this,arguments)}function zn(){return(zn=e(O)(e(A).mark((function t(r,n){return e(A).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",Fr(r,"POST","/v1/accounts:signInWithEmailLink",Mr(r,n)));case 1:case"end":return e.stop()}}),t)})))).apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Va=new Rr(5e3,15e3),qa={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Wa=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function za(e){var t=e.config;br(t.authDomain,e,"auth-domain-config-required");var r=t.emulator?Ar(t,"emulator/auth/iframe"):"https://".concat(e.config.authDomain,"/").concat("__/auth/iframe"),n={apiKey:t.apiKey,appName:e.name,v:qt},i=Wa.get(e.config.apiHost);i&&(n.eid=i);var a=e._getFrameworks();return a.length&&(n.fw=a.join(",")),"".concat(r,"?").concat(Ve(n).slice(1))}function Ha(e){return Ja.apply(this,arguments)}function Ja(){return Ja=e(O)(e(A).mark((function t(r){var n,i;return e(A).wrap((function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,Fa(r);case 2:return n=t.sent,br(i=Bi().gapi,r,"internal-error"),t.abrupt("return",n.open({where:document.body,url:za(r),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:qa,dontclear:!0},(function(t){return new Promise((n=e(O)(e(A).mark((function n(i,a){var o,s,u;return e(A).wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return u=function(){Bi().clearTimeout(s),i(t)},e.next=3,t.restyle({setHideOnLeave:!1});case 3:o=mr(r,"network-request-failed"),s=Bi().setTimeout((function(){a(o)}),Va.get()),t.ping(u).then(u,(function(){a(o)}));case 7:case"end":return e.stop()}}),n)}))),function(e,t){return n.apply(this,arguments)}));var n})));case 6:case"end":return t.stop()}}),t)}))),Ja.apply(this,arguments)}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:Wt(),t=jt(e,"auth");return t.isInitialized()?t.getImmediate():Er(e,{popupRedirectResolver:io,persistence:[ra,Ci,Pi]})}();function Co(e,t){Ei(Lo,e,t).then((function(e){e.user})).catch((function(e){e.code,e.message}))}function No(e,t){Ti(Lo,e,t).then((function(e){var t=e.user;console.log(t)})).catch((function(e){e.code,e.message}))}function Po(){Si(Lo).then((function(){})).catch((function(e){}))}Oo=function(e){e?(console.log(e),fo.classList.add("is-bck-hidden"),ho.classList.add("is-bck-hidden"),mo.classList.add("is-hidden-nav"),go.classList.add("is-hidden-nav"),bo.classList.remove("is-hidden-nav"),yo.classList.remove("is-hidden-nav"),So.classList.add("is-mobile-hidden"),To.classList.add("is-mobile-hidden"),Eo.classList.remove("is-mobile-hidden"),Io.classList.remove("is-mobile-hidden"),e.uid):(console.log(null),mo.classList.remove("is-hidden-nav"),go.classList.remove("is-hidden-nav"),bo.classList.add("is-hidden-nav"),yo.classList.add("is-hidden-nav"),So.classList.remove("is-mobile-hidden"),To.classList.remove("is-mobile-hidden"),Eo.classList.add("is-mobile-hidden"),Io.classList.add("is-mobile-hidden"))},Je(Lo).onAuthStateChanged(Oo,Ro,Ao);var Mo,Do,Uo=document.querySelector("#registration"),jo=document.querySelector("#authorization"),Bo=document.querySelector("#exit-btn"),Fo=document.querySelector("#exit-btn-mobile");Uo.addEventListener("submit",(function(e){e.preventDefault();var t=e.currentTarget.elements,r=t.email,n=t.password;if(""===r.value||""===n.value)return alert("Всі поля повинні бути заповнені!");Co(r.value,n.value),Uo.reset()})),jo.addEventListener("submit",(function(e){e.preventDefault();var t=e.currentTarget.elements,r=t.email,n=t.password;if(""===r.value||""===n.value)return alert("Всі поля повинні бути заповнені!");No(r.value,n.value),jo.reset()})),Bo.addEventListener("click",Po),Fo.addEventListener("click",Po);var Vo={watched:document.querySelector("[data-btn-watched]"),queue:document.querySelector("[data-btn-queue]")},qo="is-header-lib-active";null===(Mo=Vo.watched)||void 0===Mo||Mo.addEventListener("click",(function(){Vo.watched.classList.add(qo),Vo.queue.classList.remove(qo)})),null===(Do=Vo.queue)||void 0===Do||Do.addEventListener("click",(function(){Vo.queue.classList.add(qo),Vo.watched.classList.remove(qo)}))}();
//# sourceMappingURL=index.3a1bfa40.js.map
